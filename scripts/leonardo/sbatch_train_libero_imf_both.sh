#!/bin/bash
# ==============================================================================
# LIBERO iMF ablation: ratio=0.5 + imf_head_depth=10 (8 shared + 10 u/v)
#
# Usage:
#   sbatch scripts/leonardo/sbatch_train_libero_imf_both.sh [hydra overrides...]
# ==============================================================================

#SBATCH --job-name=imf-libero-both
...
echo "Ablation: ratio=0.5 + imf_head_depth=10"
echo "============================================"
