#!/bin/bash
# ==============================================================================
# LIBERO iMF ablation: ratio=0.5 (default 0.25)
#
# Usage:
#   sbatch scripts/leonardo/sbatch_train_libero_imf_ratio05.sh [hydra overrides...]
# ==============================================================================

#SBATCH --job-name=imf-libero-ratio05
...
echo "Ablation: ratio=0.5 (default 0.25)"
echo "============================================"
